...
father_dir = os.path.abspath(os.path.join(working_path, ".."))
java_connect_path= os.path.join(father_dir, "java_connect/")
image_type = ["png", "jpg", "jpeg"]
text_type = ["txt", "md", "csv"]

# test_path = './test/'
test_path = os.path.join(java_connect_path, "DetectTempFile/")
# filter_words_path = "./detect/Naive_BSF_DFA/dirtywords.txt"
filter_words_path = os.path.join(working_path, "detect/Naive_BSF_DFA/dirtywords.txt")
dfa = DFAFilter()
