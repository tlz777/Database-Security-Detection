...
def loadfile():
    neg=pd.read_csv('../data/neg.csv',header=None,index_col=None,encoding="gb18030")
    pos=pd.read_csv('../data/pos.csv',header=None,index_col=None,error_bad_lines=False,encoding="gb18030")
    neu=pd.read_csv('../data/neutral.csv', header=None, index_col=None,encoding="gb18030")
...
def train_lstm(n_symbols,embedding_weights,x_train,y_train,x_test,y_test):
    ...
    with open('../model/lstm.json', 'w') as outfile:
        outfile.write( yaml.dump(json_string, default_flow_style=True) )
